...
export class Ruleta extends Juego {
  ...
  async ejecutar(jugador:Jugador):Promise<{apuestaTotal: number;resultado: "victoria" | "derrota";ganancia?: number;}>{
  ...
  private async mostrarResultado(resultado: "victoria" | "derrota",jugador:Jugador) {
    console.log("|||||||||||||||||||||||||||||||||||||||||||||||||||||||");
    if (resultado === "victoria") {
      console.log("🎉 🍾  =======================================  🎉 🍾");
      console.log("         🥇 🏆 ¡FELICIDADES! ¡HAS GANADO! 🥇 🏆");
      console.log("=======================================================");
      console.log(`💰                 Saldo acumulado: ${jugador.obtenerSaldo() }`);
  ...
  private async mostrarInstrucciones(){
    ...
    let resp= await Menu.elegirOpcion("Presione enter para continuar: ",[{valor:"continuar",nombre:"Continuar"}])
  }
  ...
  private async comprobarSaldo(jugador:Jugador){
    if (jugador.obtenerSaldo()<this.apuestaMinima){
      ...
      console.log("                       -----------------------------------------------------------------"+"\n");
      let resp=await Menu.elegirOpcion("Presione enter para salir: ",[{valor:"continuar",nombre:"salir"}])
      return false; 
  ...
  private ruletaGirando(resultado: "victoria" | "derrota",jugador:Jugador,resul:number,color:string):void{
